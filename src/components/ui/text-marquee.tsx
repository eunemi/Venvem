      ...
      <style>
        {`
          @keyframes slide-vertical {
            to {
              transform: translateY(var(--destination));
            }
          }
        `}
      </style>
      <div className={cn("flex relative", className)}>
        <div className="flex relative overflow-hidden flex-row gap-1 items-center w-auto h-min">
          {prefix && (
          ...
          <div
            className="opacity-100 relative w-auto min-w-[150px] overflow-hidden"
            style={{ 
              height: `${height}px`,
              ...
              {React.Children.map(children, (child, index) => (
                <div
                  ...
                  style={{
                    ...
                    transform: `translateY(var(--origin))`,
                    animation:
