    ...
    <section className="py-16">
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
            <div className="max-w-md">
                ...
                <p className="text-gray-400 mt-2">Extend and automate your workflow by using integrations for your favorite tools.</p>
            </div>
            <ul className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {
                    integrations.map((item, idx) => (
                        <li key={idx} className="border border-white/10 rounded-xl bg-white/5 backdrop-blur-sm overflow-hidden hover:bg-white/10 transition-colors">
                            <div className="flex items-start justify-between p-6">
                                ...
                                <button className="text-gray-300 text-sm border border-white/20 rounded-lg px-4 py-2 duration-150 hover:bg-white/10 hover:text-white">Connect</button>
                            </div>
                            <div className="py-4 px-6 border-t border-white/10 text-right bg-black/20">
                                <a href="javascript:void(0)" className="text-indigo-400 hover:text-indigo-300 text-sm font-medium">
                                    View integration
                                </a>
                            </div>
                        </li>
